...
class CommonController extends Controller {
    ...
    //初始化对象实例
    public function registObj($objName,$dataInfo,$nameSpace="app\common\\"){
        $className=$nameSpace.$objName;
        $this->objList[$objName] = new $className($dataInfo);
    }
    
    //获取对象实例
    public function getObj($objName){
        if(isset($this->objList[$objName])){
            return $this->objList[$objName];
        }
        return;
    }
